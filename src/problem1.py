...
def run_test_problem1a():
    ...
    # Test 3:
    expected = -0.185  # This is APPROXIMATELY the correct answer.
...
def run_test_problem1b():
    ...
    # Test 4:
    expected = 3238  # This is APPROXIMATELY the correct answer.
    answer = problem1b(30, 1001)
    print()
    print('Test 4 expected:', expected, '(approximately)')
    print('       actual:  ', answer)
